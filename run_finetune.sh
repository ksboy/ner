...
BERT_MODEL=./output/ccks/trigger/base/identification/checkpoint-best/
OUTPUT_DIR=./output/$DATASET/$TASK/base-\>few/identification/
BATCH_SIZE=16
EVAL_BATCH_SIZE=64
NUM_EPOCHS=10000
WARMUP_STEPS=100
...
--task $TASK \
--data_dir $DATA_DIR \
--labels ./data/FewFC-main/event_schema/$DOMAIN.json \
--model_type bert \
...
# # BERT_MODEL=/home/whou/workspace/pretrained_models/bert-base-cased
# # BERT_MODEL=/hy-nas/workspace/pretrained_models/chinese_bert_wwm_ext_pytorch/
# BERT_MODEL=./output/ccks/$TASK/base/joint/checkpoint-best/
# OUTPUT_DIR=./output/$DATASET/$TASK/base-\>few/joint/
# BATCH_SIZE=16
# EVAL_BATCH_SIZE=64
# NUM_EPOCHS=10000
# WARMUP_STEPS=100
